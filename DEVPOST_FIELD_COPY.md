...
This file is the version 23 field-aligned source for the authenticated OpenAI Build Week draft. Copy only the contents beneath the matching field heading after the application and presentation sequence are locked. Do not copy this preface or the saved-field reference into Devpost.
...
- Production version 23 at audited runtime commit `65b39285520cf871df1081d6899b083af3edbd83`: 100 passing tests, clean TypeScript and lint, a full compiled failure matrix, public desktop/mobile browser audits, hardened recovery-read boundaries, persisted-only Timeline inspection, progressive Witness disclosure, cited title/Missing seams, refined typography/mobile containment, exact witnessed display titles, and zero production dependency vulnerabilities.
...
The judging recovery above was generated by proof-producing version 7 runtime `042215042dd46ded14b501f961f4d9e7debb8178`; current production Sites version 23 serves and audits that persisted receipt 1.0 row but did not generate its GPT-5.6 decisions.
