...
const DEVPOST_MEDIA_STATUS_CLAIM = "Status: authenticated Devpost About, judge instructions, project thumbnail, six-image gallery, and public YouTube video synchronized and Preview-verified. Rules acceptance and final submission remain pending.";
