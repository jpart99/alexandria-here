...
Production Sites version 16 ships content-neutral query-bearing and archived `.onion` HTTP(S) locator support, receipt `1.3` query identity, and permanent receipt `1.0`–`1.2` pathname-only compatibility. Its saved version deployed successfully and its hosted production and live submission gates passed; the exact judging row remains receipt `1.0` and is not presented as evidence generated by v16.
...
The sealed master shows ordinary production recovery `8ea53a47-437b-4afe-ad2c-29c81637a327`; its planner, model, and count claims remain receipt-backed. Current judging links use corrected recovery `18026989-33be-4011-86ee-19e1754cb22c`, generated by the proof-producing version 7 runtime `042215042dd46ded14b501f961f4d9e7debb8178`, whose decision attribution separates deterministic era selection from GPT-5.6 page-order and primary-witness decisions. Accepted production Sites version 16 serves that persisted receipt 1.0 proof without claiming that v16 generated it.
