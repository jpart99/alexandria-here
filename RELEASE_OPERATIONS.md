...
Production Sites version 14 was accepted only after the hosted gate passed against the public origin. Its audited source commit is `7c15b567d056ce13c6ef1bab4bf56aced3115cc0`; saved version `appgprj_6a5b165146ec8191a6507491526ca6eb~appgver_29a5f9fa56248191adcc87a5bd6ec25c`; deployment `appgdep_6a5c5de830b0819188e12f3f3a0b1ad4`; environment revision 7. The source gate passed 70 tests; TypeScript, lint, the clean production build, dependency audit, compiled release gate, hosted production gate, and live submission proof also passed. The hosted check proved the scheme-less form contract, pre-admission rejection of a bare private address, exact browser-only alias discovery, no physical `/fonts/` namespace leakage, exact font bytes and headers, GET/HEAD/Range/ETag/304 behavior, ordinary asset bypass, safe missing-alias handling, unsafe-URL rejection, fail-closed receipt lookup, and exact agreement with persisted reference recovery `18026989-33be-4011-86ee-19e1754cb22c`. Unit gates separately prove that a safe bare public address inventories both HTTP and HTTPS archive variants, merges and deduplicates the witnesses, retains the 12-record/8-fetch budgets, rejects replay redirects whose timestamp, target, or modifier differs from the requested archive identity, and refuses to turn synthetic fallback labels into preserved content.
