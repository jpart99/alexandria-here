...
Production Sites version 13 was accepted only after the hosted gate passed against the public origin. Its audited source commit is `fbb1153a831455513cc700cac0db0c5d40d2e59f`; saved version `appgprj_6a5b165146ec8191a6507491526ca6eb~appgver_11f255a52e588191b76307da320fbe10`; deployment `appgdep_6a5c4df0a40c8191a791de2673f822ee`; environment revision 7. The source gate passed 66 tests. The hosted check proved the scheme-less form contract, pre-admission rejection of a bare private address, exact browser-only alias discovery, no physical `/fonts/` namespace leakage, exact font bytes and headers, GET/HEAD/Range/ETag/304 behavior, ordinary asset bypass, safe missing-alias handling, unsafe-URL rejection, fail-closed receipt lookup, and exact agreement with persisted reference recovery `18026989-33be-4011-86ee-19e1754cb22c`. Unit gates separately prove that a safe bare public address inventories both HTTP and HTTPS archive variants, merges and deduplicates the witnesses, and retains the 12-record/8-fetch budgets.
