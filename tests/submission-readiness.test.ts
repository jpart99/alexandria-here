...
test("the sealed submission package passes locally and exposes only authority-gated work", async () => {
  ...
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("Production version 18 at audited runtime commit", "Production version 17 at audited runtime commit")),
    /submission runtime provenance/,
  );
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("proof-producing version 7 runtime", "proof-producing version 18 runtime")),
    /submission runtime provenance/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("appgdep_6a5caab525508191ac8eb45c0b3e7fae", "appgdep_00000000000000000000000000000000")),
    /submission runtime provenance/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace(
      "Production version 18 passed the full eight-boundary compiled failure matrix.",
      "Production version 18 did not pass the full eight-boundary compiled failure matrix.",
    )),
    /submission runtime provenance/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertYouTubeRuntimeProvenance(youtubeMetadata.replace("generated by version 7 runtime", "generated by version 18 runtime")),
    /YouTube runtime provenance/,
  );
  assert.throws(
    () => assertYouTubeRuntimeProvenance(youtubeMetadata.replace("174e05a38d5a49a17d5d116cb79f8a3c53963286", "042215042dd46ded14b501f961f4d9e7debb8178")),
    /YouTube runtime provenance/,
  );
  assert.throws(
    () => assertYouTubeRuntimeProvenance(`${youtubeMetadata}\nThe proof was generated by version 18 runtime \`174e05a38d5a49a17d5d116cb79f8a3c53963286\`.`),
  ...
  for (const key of Object.keys(releaseDocuments) as Array<keyof typeof releaseDocuments>) {
    const staleDocuments = {
      ...releaseDocuments,
      [key]: releaseDocuments[key].replace(
        "174e05a38d5a49a17d5d116cb79f8a3c53963286",
  ...
  assert.throws(
    () => assertDevpostFieldCopy(devpostFieldCopy.replace("93 passing tests", "36 passing tests")),
    /Devpost About copy/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertDevpostFieldCopy(devpostFieldCopy.replace(
      ...
      "The judging proof was generated by production version 18.\n\n## Test instructions for judges",
    )),
    /production version 18 generated the persisted judging proof/,
  );
  assert.throws(
