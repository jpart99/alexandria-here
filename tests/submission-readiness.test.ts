...
test("the sealed submission package passes locally and exposes only authority-gated work", async () => {
  ...
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("Production version 16 at audited runtime commit", "Production version 15 at audited runtime commit")),
    /submission runtime provenance/,
  );
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("proof-producing version 7 runtime", "proof-producing version 16 runtime")),
    /submission runtime provenance/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("appgdep_6a5c90b3020c81919c73b5a84e39580e", "appgdep_00000000000000000000000000000000")),
    /submission runtime provenance/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertYouTubeRuntimeProvenance(youtubeMetadata.replace("generated by version 7 runtime", "generated by version 16 runtime")),
    /YouTube runtime provenance/,
  );
  assert.throws(
    () => assertYouTubeRuntimeProvenance(youtubeMetadata.replace("d32ab887e880d7f3d4bbf1c9d71e0aec37388a43", "042215042dd46ded14b501f961f4d9e7debb8178")),
    /YouTube runtime provenance/,
  );
  assert.throws(
    () => assertYouTubeRuntimeProvenance(`${youtubeMetadata}\nThe proof was generated by version 16 runtime \`d32ab887e880d7f3d4bbf1c9d71e0aec37388a43\`.`),
  ...
  for (const key of Object.keys(releaseDocuments) as Array<keyof typeof releaseDocuments>) {
    const staleDocuments = {
      ...
      [key]: releaseDocuments[key].replace(
        "d32ab887e880d7f3d4bbf1c9d71e0aec37388a43",
