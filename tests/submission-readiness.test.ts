...
test("the sealed submission package passes locally and exposes only authority-gated work", async () => {
  ...
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("Production version 19 at audited runtime commit", "Production version 18 at audited runtime commit")),
    /submission runtime provenance/,
  );
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("proof-producing version 7 runtime", "proof-producing version 19 runtime")),
    /submission runtime provenance/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace("appgdep_6a5ccae8dcf48191b85e5a80613dc594", "appgdep_00000000000000000000000000000000")),
    /submission runtime provenance/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertSubmissionRuntimeProvenance(submission.replace(
      "Production version 19 passed the full eight-boundary compiled failure matrix.",
      "Production version 19 did not pass the full eight-boundary compiled failure matrix.",
    )),
    /submission runtime provenance/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertYouTubeRuntimeProvenance(youtubeMetadata.replace("generated by version 7 runtime", "generated by version 19 runtime")),
    /YouTube runtime provenance/,
  );
  assert.throws(
    () => assertYouTubeRuntimeProvenance(youtubeMetadata.replace("88a4dce91b42a3fcc1d2adf9710de6bea651dfc4", "042215042dd46ded14b501f961f4d9e7debb8178")),
    /YouTube runtime provenance/,
  );
  assert.throws(
    () => assertYouTubeRuntimeProvenance(`${youtubeMetadata}\nThe proof was generated by version 19 runtime \`88a4dce91b42a3fcc1d2adf9710de6bea651dfc4\`.`),
  ...
  assert.throws(
    ...
    /stale pre-v19 current-runtime claim/,
  );
  ...
  for (const key of Object.keys(releaseDocuments) as Array<keyof typeof releaseDocuments>) {
    const staleDocuments = {
      ...releaseDocuments,
      [key]: releaseDocuments[key].replace(
        "88a4dce91b42a3fcc1d2adf9710de6bea651dfc4",
  ...
  assert.throws(
    () => assertDevpostFieldCopy(devpostFieldCopy.replace("96 passing tests", "36 passing tests")),
    /Devpost About copy/,
  );
  assert.throws(
  ...
  assert.throws(
    () => assertDevpostFieldCopy(devpostFieldCopy.replace(
      ...
      "The judging proof was generated by production version 19.\n\n## Test instructions for judges",
    )),
  ...
  assert.throws(
    () => assertDevpostFieldCopy(devpostFieldCopy.replace(
      "## Test instructions for judges",
      "The judging recovery was generated by production Sites version 19.\n\n## Test instructions for judges",
    )),
    /non-proof runtime generated the persisted judging proof/,
  );
  assert.throws(
...
test("final mode cannot bypass either Devpost text or media synchronization", () => {
  const text = "Replace the saved Devpost About and judge instructions with `DEVPOST_FIELD_COPY.md`, save, then verify Preview shows `96 passing tests` and the current judging recovery.";
